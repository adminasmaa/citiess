...
class RepairsDataTable extends DataTable
{
    private $crudName = 'repairs';
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('created_at', function ($model) {
                ...
                return (!empty($model->employee)) ? $model->employee->first_name : '';
            })
            ->addIndexColumn()
     ...
     */
    public function query(AcRepair $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('type')->title(trans('site.servicetype')),
            Column::make('price')->title(trans('site.estimatedprice')),

            Column::make('employee_id')->title(trans('site.emlpoyeesname')),
            Column::make('time')->title(trans('site.avaiabletime')),
