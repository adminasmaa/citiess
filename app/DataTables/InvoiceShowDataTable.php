...
class InvoiceShowDataTable extends DataTable
{
    private $crudName = 'invoiceshowclient';
...
//                Button::make('create')->text('<a href="{{url("dashboard/invoicesbase/create")}}"> <i class="fa fa-plus"></i> ' . trans('site.add') . '</a>'),
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('invoice_type')->title(trans('site.invoice_type')),
    ...
    {
        return 'InvoiceShow_' . date('YmdHis');
    }
}
