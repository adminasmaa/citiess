    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('category_id', function ($model) {
                ...
                $url = asset("images/products/$model->image");
    ...
    public function getColumns(): array
    {
        $lan = app()->getLocale();
            ...
            return [
                ...
                Column::make('image')->title(trans('site.product_image')),
                Column::make('name_'.$lan)->title(trans('site.product_name')),
                Column::make('category_id')->title(trans('site.category_name')),
