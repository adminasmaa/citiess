...
<img  class="d-block rounded me-1" src="{{asset('images/logo.png')}}" alt="logo" width="100%">

</span>
                    <h2 class="brand-text">Cities</h2></a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Invoice">MemberShip Moodle</span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{route('dashboard.roles.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Preview">@lang('site.roles')</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{route('dashboard.users.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">@lang('site.users')</span></a>
                    </li>
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">@lang('site.city map management')</span></a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{route('dashboard.zones.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">@lang('site.zones')</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{route('dashboard.blocks.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Preview">@lang('site.blocks')</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{route('dashboard.units.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Edit">@lang('site.units')</span></a>
                    </li>

                </ul>
            </li>
            {{--            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('dashboard.units.index')}}"><i data-feather="save"></i><span class="menu-title text-truncate" data-i18n="File Manager">@lang('site.units')</span></a>--}}
            {{--            </li>--}}
            ...
            {{--                </ul>--}}
            {{--            </li>--}}
            {{--            <li class=" nav-item"><a class="d-flex align-items-center" href="{{route('dashboard.users.index')}}"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">@lang('site.users')</span></a>--}}
            {{--                <ul class="menu-content">--}}
            {{--                    <li><a class="d-flex align-items-center" href="{{route('dashboard.users.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">List</span></a>--}}
            {{--                    </li>--}}
            ...
            {{--                </ul>--}}
            {{--            </li>--}}
                        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="check-square"></i><span class="menu-title text-truncate" data-i18n="Pages">@lang('site.client')</span></a>
                            <ul class="menu-content">
                                <li>

                              <a class="d-flex align-items-center" href="{{route('dashboard.clients.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Authentication">@lang('site.clients')</span></a>


                                </li>
                            </ul>
            <li><a class="d-flex align-items-center" href="{{route('dashboard.installments.index')}}"><i data-feather="grid"></i><span class="menu-item text-truncate" data-i18n="Account Settings">@lang('site.installments')</span></a>
            </li>
{{--            <li class=" nav-item"><a class="d-flex align-items-center" href=""><i--}}
{{--                        data-feather="check-square"></i><span class="menu-title text-truncate" data-i18n="Todo">@lang('site.clients') @endlang</span></a>--}}
{{--            </li>--}}
