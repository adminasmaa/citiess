                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form action="{{ route('dashboard.invoicesbase.store') }}"
                                                      method="post"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <!--            <option-->
                                                            <!--                value="{{$unit->id}}">{{$unit->name_en ?? ''}}</option>-->
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="invoice_type" id="invoicetype">
                                                                    ...
                                                                    @foreach(\App\Models\BasicInvoice::where('type','=','type')->get() as $invoice )
                                                                    <option
                                                                        value="{{$invoice->invoice_name}}">{{$invoice->invoice_name ?? ''}} </option>
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="type" >
                                                                    ...
                                                                    <option
                                                                        value="Paid">@lang('site.Invoices Paid') </option>
                                                                              <option
                                                                        value="unPaid">@lang('site.Invoices UnPaid') </option>
