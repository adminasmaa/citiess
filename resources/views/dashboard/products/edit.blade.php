                        ...
                        <div class="col-lg-12 col-12">
                            <div class="card card-company-table">
                                <div class="card-body p-0">
                                    ...
                                    <form action="{{ route('dashboard.products.update', $data->id) }}" method="post"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 form-group col-12 p-2">
                                                    ...
                                                    <select class="form-control" name="category_id" id="zone_id">
                                                        <option
                                                            value="0">@lang('site.select')</option>
                                                        @foreach($categories as $cat)
                                                            <option
                                                                value="{{$cat->id}}"  @if($data->status==$cat->id) selected @endif>{{$cat->name ?? ''}}</option>
                                                ...
                                                <div class="col-md-6 form-group col-12 p-2">
                                                    ...
                                                    <textarea type="text" name="description_ar"
                                                              class="form-control"
                                                              cols="4" rows="4">{{ $data->description_ar ?? '' }}</textarea>
                                                </div>
                                                ...
                                                <div class="col-md-6 form-group col-12 p-2">
                                                    ...
                                                    <textarea type="text" name="description_en"
                                                              class="form-control"
                                                              cols="4" rows="4">{{ $data->description_en ?? '' }}</textarea>
                                                </div>
