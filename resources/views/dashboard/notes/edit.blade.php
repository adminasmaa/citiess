                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form action="{{ route('dashboard.notes.update',$note->id) }}"
                                                      method="post"
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="section_id" required>
                                                                    ...
                                                                    @foreach($sections as $section)
                                                                        <option
                                                                            value="{{$section->id}}" @if($note->section_id==$section->id) selected @endif>{{$section->section ?? ''}}</option>
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="employee_id" required>
                                                                    ...
                                                                    @foreach($employes as $employe)
                                                                        <option
                                                                            value="{{$employe->id}}" @if($note->employee_id==$employe->id) selected @endif>{{$employe->first_name ?? ''}}</option>
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <textarea type="text" name="notes"
                                                                          class="form-control"
                                                                          cols="4" rows="4">{{ $note->notes ?? '' }}</textarea>
                                                            </div>
