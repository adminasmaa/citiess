                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form action="{{ route('dashboard.zones.update',$zone->id) }}" method="post"
...
{{--                                                            <h4 class="card-title">@lang('site.zones')</h4>--}}
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <label>@lang('site.absorption')</label>
                                                                <span class="text-danger">*</span>
                                                                <input type="text" name="absorption" class="form-control"
                                                                       value="{{ $zone->absorption }}">
                                                            </div>
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                        ...
                                                        <div class="row m-0">
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <textarea type="text" name="description_ar"
                                                                          class="form-control"
                                                                          cols="4" rows="4">{{$zone->description_ar ?? ''}}</textarea>
                                                            </div>
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <textarea type="text" name="description_en"
                                                                          class="form-control"
                                                                          cols="4" rows="4">{{$zone->description_en ?? ''}}</textarea>
                                                            </div>
