                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <form action="{{ route('dashboard.invoiceType.update',$invoice->id) }}" method="post"
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="invoice_type">
                                                                    ...
                                                                    <option
                                                                        value="water" @if($invoice->invoice_type=='water')  selected @endif>@lang('site.water') </option>
                                                                    <option value="electricity" @if($invoice->invoice_type=='electricity')  selected @endif>@lang('site.electricity')</option>
                                                                    <option value="theinternet"  @if($invoice->invoice_type=='theinternet')  selected @endif>@lang('site.theinternet')</option>
                                                            ...
                                                            <div class="col-md-6 form-group col-12 p-2">
                                                                ...
                                                                <select class="form-control" name="client_id">
                                                                    ...
                                                                    @foreach(\App\Models\Client::all() as $client)
                                                                        <option
                                                                            value="{{$client->id}}" @if($invoice->client_id==$client->id) selected @endif>{{$client->name ?? ''}}</option>
